...
for name_model in model_all:
    ...
    for the_id in ids:
        ...
        w1 = 1.0; w2 = 4.0; w3 = 1.0 # HERE weights for avg, lgbm, unet
...
#                'pred25bp_' + the_id + '_' + the_chr + '.npy')
            ...
            # L model
            the_name1='DGHK_F'
            pred11 = np.load(path1 + 'lgbm_' + the_name1 + '_v1/' + \
                'pred25bp_' + the_id + '_' + the_chr + '.npy')
            pred11 = pred11 + np.load(path2 + 'lgbm_' + the_name1 + '_v1/' + \
                'pred25bp_' + the_id + '_' + the_chr + '.npy')
#            pred11 = pred11 + np.load(path3 + 'lgbm_' + the_name1 + '_v1/' + \
#                'pred25bp_' + the_id + '_' + the_chr + '.npy')
            pred11 = pred11 / 2.0
            the_name2='DGHKLMN_F'
            pred111 = np.load(path1 + 'lgbm_' + the_name2 + '_v1/' + \
                'pred25bp_' + the_id + '_' + the_chr + '.npy')
            pred111 = pred111 + np.load(path2 + 'lgbm_' + the_name2 + '_v1/' + \
                'pred25bp_' + the_id + '_' + the_chr + '.npy')
#            pred111 = pred111 + np.load(path3 + 'lgbm_' + the_name2 + '_v1/' + \
#                'pred25bp_' + the_id + '_' + the_chr + '.npy')
            pred111 = pred111 / 2.0
            w111 = dict_model_count[name_model]
            w222 = dict_model_count[the_name1] 
            w333 = dict_model_count[the_name2] 
            pred1 = (pred1 * w111 + pred11 * w222 + pred111 * w333) / (w111 + w222 + w333)
            ##########################
#            # 1.3 unet
...
#            pred_stack = (avg * w11 + pred1 * w22) / (w11 + w22)
#            ###################
#            ## 2. anchor bottom 90%
