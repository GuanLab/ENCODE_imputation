...
#                'pred25bp_' + the_id + '_' + the_chr + '.npy')
            ...
            # L model
            the_name='DGIK_F'
            pred11 = np.load(path1 + 'lgbm_' + the_name + '_v1/' + \
                'pred25bp_' + the_id + '_' + the_chr + '.npy')
            pred11 = pred11 + np.load(path2 + 'lgbm_' + the_name + '_v1/' + \
                'pred25bp_' + the_id + '_' + the_chr + '.npy')
#            pred11 = pred11 + np.load(path3 + 'lgbm_' + the_name + '_v1/' + \
#                'pred25bp_' + the_id + '_' + the_chr + '.npy')
            pred11 = pred11 / 2.0
            w111 = dict_model_count[name_model]
            w222 = dict_model_count[the_name] 
            pred1 = (pred1 * w111 + pred11 * w222) / (w111 + w222)
            ##########################
#            # 1.3 unet
