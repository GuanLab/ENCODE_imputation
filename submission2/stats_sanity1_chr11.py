...
path_computer='/home/hyangl/2019/encode_imputation/data/'
...
path1 = './'
path2 = path_computer + 'baseline_avg_final/'
path3 = './stats1/'
...
id_all=glob.glob(path1 + '*chr11.npy')
id_all.sort()
...
for the_id in id_all:
    ...
    filescore=open(path3 + 'stats_' + the_id + '_' + list_chr[0] + '.txt','w')
